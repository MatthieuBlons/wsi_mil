...
def get_arguments(raw_args=None, train=True, config=None):
    ...
    parser.add_argument(
        "--wsi",
        type=str,
        help="Path to the tiled WSI global folder (containing several resolutions)",
    )
    parser.add_argument(
        "--target_name",
        type=str,
        help="Name of the target variable as referenced in the table_data.",
    )
    ...
    parser.add_argument(
        "--sampler",
        type=str,
        help="Type of tile sampler. dispo : random | biopsie",
        default="random",
    )
    parser.add_argument(
    ...
    args.patience_lr = (
        args.patience_lr if args.patience_lr is None else args.patience_lr
    )
